...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4G5VvBMCfMxoCpyTLszv"; // AccessKeyId

        $accessKeySecret = "eaZWdAiH82VLuQfeP8iTyfXXw2cm8z"; // AccessKeySecret
    ...
    public static function sendSms() {
        ...
        $request->setSignName("爆棚科技");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_190160015");
        $code=$_GET['telcode'];

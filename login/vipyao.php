        ...
        <section class="aui-flexView">
            ...
            <section class="aui-scrollView">
                <div class="aui-code-box">
                    <form name="registerform" id="registerform" action="vipregister.php">
                        ...
                        <div class="aui-code-btn">
							...
							<p style="margin: 0 0 0.625rem 0;font-size: 0.8125rem;">点击 [ 注册 ] 按钮即代表同意<a href="#" class="agree">《注册协议》</a></p>

        ...
        <section class="aui-flexView">
            ...
            <section class="aui-scrollView">
                <div class="aui-code-box">
                    <form name="registerform" id="registerform" action="register.php">
						<p class="aui-code-line">
						    <input type="text" class="aui-code-line-input" name="username" value="" id="name"  placeholder="请输入头条/抖音名"/>
						</p>
                        <p class="aui-code-line">
                       ...
                       <div class="aui-flex-links">                           
                        ...
                        <div class="aui-code-btn">
							...
							<p style="margin: 0 0 0.625rem 0;font-size: 0.8125rem;">点击 [ 注册 ] 按钮即代表同意<a href="xieyi.html" class="agree">《注册协议》</a></p>

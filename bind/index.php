...
-->
			...
			<div style="text-align: center;">
				<button id="savePicture" style="width:280px;height:50px;line-height:45px;border:1px solid #c378bb;border-radius:25px;background-color: transparent;color:#c378bb;font-size:16px">选择二维码绑定对应小程序</button>
			</div>
		</div>
		<!-- 弹窗 -->
